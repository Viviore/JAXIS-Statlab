...
export default function AdminDisputesPage() {
  ...
  const handleConfirmChargeback = async (e: React.FormEvent) => {
    ...
    if (chargebackReason.trim().length < 10) {
      setActionError("Please enter at least 10 characters explaining why the study is halted.");
      return;
    }
    ...
    try {
      ...
      if (res.success) {
        setToast({
          ...
          description: "Study status changed to HALTED and milestone payouts have been locked.",
        });
  ...
  return (
    <div className="flex flex-col gap-8 max-w-7xl mx-auto pb-24 w-full animate-content-fade font-sans">
      ...
      <PageHeader
        ...
        title="Study Claims & Disputes Queue"
        description="Review client claims, check attached files against SOW scope, and mark claims for CEO decision."
      />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 sm:gap-6">
        ...
        <KpiCard
          ...
          description="Projects frozen with locked payouts"
        />
        <KpiCard
            ...
            <form onSubmit={handleConfirmChargeback} className="flex flex-col gap-4 text-xs">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  placeholder="State the payment processor claim, bank notice, or customer reason..."
