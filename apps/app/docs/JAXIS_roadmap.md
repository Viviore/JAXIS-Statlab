...
- Tailwind CSS v4 installed; `src/app/globals.css` populated with all design tokens from `JAXIS_design-system.md`
...
**Depends on:** `00`\
**Domain:** Identity\
**Spec:** [`docs/modules/JAXIS_01-auth.md`](./modules/JAXIS_01-auth.md)
...
- Payout rate config (from `JAXIS_scope.md` Section 18):
