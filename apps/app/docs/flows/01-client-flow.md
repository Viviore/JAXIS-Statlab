...
## 2. Screen-by-Screen Guide: Where to Click

### Screen 1: The Main Dashboard (`My Studies`)
When you log in, you will see your **"My Studies"** page:

```
┌─────────────────────────────────────────────────────────────────────────┐
│ [📊 My Studies]  [📄 Quotes]  [💬 Messages]  [🎓 Defense Practice]      │
├─────────────────────────────────────────────────────────────────────────┤
│ Welcome back!                                [+ Submit New Request]     │
│                                                                         │
│ ┌─────────────────────────────────────────────────────────────────────┐ │
│ │ 💡 NEED STATISTICAL ANALYSIS FOR A NEW PAPER OR THESIS?             │ │
│ │ Submit your questionnaire or raw data to get started in 5 minutes.  │ │
│ │                                             [Start New Request →]   │ │
│ └─────────────────────────────────────────────────────────────────────┘ │
│                                                                         │
│ [ 4 Total Studies ]   [ 1 Action Needed ]   [ 1 Ready for Download ]    │
│                                                                         │
│ YOUR RESEARCH STUDIES                                                   │
│ ┌─────────────────────────────────────────────────────────────────────┐ │
│ │ 📘 Predictors of Patient Readmission in Metro Manila Hospitals       │ │
│ │ Target Date: Sep 10, 2026 • ID: JAXIS-5622                          │ │
│ │ ─────────────────────────────────────────────────────────────────── │ │
│ │  (✓ Submitted) ── (✓ Quote) ── (● ANALYZING) ── ( QA ) ── ( Ready ) │ │
│ │ ─────────────────────────────────────────────────────────────────── │ │
│ │ [ 💬 Message Statistician ]               [ View Details & Files → ]│ │
│ └─────────────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────────────┘
```

- **Top Big Box:** If you have a new paper, click the orange button **"Start New Request →"**.
- **Action Needed Alert:** If our team needs you to approve a price quote or send an extra file, you will see an alert with a single button telling you what to do.
- **Your Study Cards:** Each thesis appears in its own card showing a 5-dot progress bar so you immediately see where your paper is.
...
#### Step 1 of 3: Scope & Details
- **Research Study Title:** Type the title of your thesis or paper.
- **Research Questions:** Type the questions you need answered (for example: *"1. What is the demographic profile of the respondents? 2. Is there a significant relationship between stress and job performance?"*).
- **Target Deadline:** Pick the date on the calendar when you need the finished tables.
- Click **"Proceed to Attachments →"**.

#### Step 2 of 3: Document & Dataset Uploads
- **Upload Raw Data:** Drag and drop your survey answers (Excel file `.xlsx`, `.csv`, or SPSS `.sav`).
- **Upload Questionnaire:** Drag and drop your survey tool or Chapter 1–3 draft so the statistician knows what each question measures.
- Click **"Proceed to Review →"**.

#### Step 3 of 3: Review & Submit
- Check that your title and attachments look right.
- Click **"Submit Study Request"**.
- **Done!** You will receive a unique tracking ID (e.g. `JAXIS-202608-5622`).
