...
**Derived from:** `JAXIS_scope.md` · `JAXIS_roadmap.md` · `ARCHITECTURE.md`\
...
```
apps/app/
├── JAXIS_architecture.md           ← This document
├── JAXIS_tasks.md                  ← Active module task tracking
│
├── .agents/
│   └── rules/
│       └── JAXIS_guardrails.md     ← Stack-specific guardrails (RULE_REL, RULE_QUO, etc.)
│
├── docs/
│   ├── JAXIS_scope.md              ← Business & product scope (source of truth)
│   ├── JAXIS_design-system.md      ← Color tokens, typography, component specs
│   ├── JAXIS_roadmap.md            ← Numbered module sequence (00–17, Roadmap v2)
│   └── modules/                    ← Per-module implementation specs
│       ├── JAXIS_00-foundation.md
│       ├── JAXIS_01-auth.md
│       ├── JAXIS_02-staff.md              ← Expert Provisioning (moved from 17)
│       ├── JAXIS_03-client-profile.md
│       ├── JAXIS_04-intake.md
│       ├── JAXIS_05-quotation.md
│       ├── JAXIS_06-sow.md
│       ├── JAXIS_07-payments.md
│       ├── JAXIS_08-assignment.md
│       ├── JAXIS_09-messaging.md          ← Messaging (moved from 11)
│       ├── JAXIS_10-analysis.md
│       ├── JAXIS_11-qa.md
│       ├── JAXIS_12-deliverables.md       ← Deliverables + Revisions (merged)
│       ├── JAXIS_13-defenselab.md
│       ├── JAXIS_14-finance.md
│       ├── JAXIS_15-disputes.md
│       ├── JAXIS_16-notifications.md
│       └── JAXIS_17-reporting.md          ← Reporting + Archive (merged)
│
├── prisma/
