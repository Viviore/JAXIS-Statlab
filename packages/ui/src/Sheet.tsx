...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-[#010114]/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
export const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-left border-b border-white/[0.06] pb-3 mb-4",
      className
    )}
    {...props}
  />
...
export const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 pt-3 border-t border-white/[0.06] mt-auto",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("font-mono text-base font-bold text-white tracking-wide uppercase", className)}
    {...props}
  />
));
